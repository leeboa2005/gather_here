  ...
  return (
    <div className="w-[400px] h-[400px] relative bg-white rounded-[20px] ">
      <div className="text-center mt-8">
        ...
        <div className="mt-2 text-center text-gray-600 text-m font-semibold italic">Welcome to @gather_here</div>
        <div className="w-full h-40 rounded-md mb-4 flex items-center justify-center overflow-hidden">
          <div className="bg-gray-200 w-full h-full flex items-center justify-center">이미지?</div>
        </div>
        <div className="mt-4 text-left text-gray-600">
          ...
          <p>
            <strong>직업:</strong> {job_title}
          </p>
          <p>
            <strong>경력:</strong> {experience}
          </p>
          <p>
            <strong>블로그:</strong> {blog}
          </p>
        </div>
      </div>
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full px-4">
        <button onClick={handleExplore} className="w-full bg-blue-500 text-white py-2 rounded-md mb-4">
          구경가기
        </button>
      </div>
    </div>
